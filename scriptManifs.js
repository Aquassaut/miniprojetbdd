...
var popForm = function(nb) {
    ...
    lign.innerHTML = '' +
        ...
        '       <div class="ym-fbox">' +
        '           <input type="text" placeholder="Nom de la manifestation">' +
        '       </div>' +
        '   </div>' +
        '</td>' +
        '<td>' +
        '   <div class="ym-form ym-full">' +
        '       <div class="ym-fbox">' +
        '           <input type="date" placeholder="Date de la manifestation">' +
        '       </div>' +
        '   </div>' +
        '</td>' +
        '<td>' +
        '   <div class="ym-form ym-full">' +
        '       <div class="ym-fbox">' +
        '           <input type="text" placeholder="Nom de l\'IUT organisateur">' +
        '       </div>' +
        '   </div>' +
        '</td>' +
        '<td>' +
